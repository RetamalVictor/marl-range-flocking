...
class CriticNetwork(nn.Module):
    def __init__(
        ...
        if not os.path.exists(chkpt_best_dir):
            os.makedirs(chkpt_best_dir)
    ...
    def save_checkpoint_best(self):
        print("... saving checkpoint ...")
        T.save(self.state_dict(), self.checkpoint_best_file)
...
class ActorNetwork(nn.Module):
    def __init__(
        ...
        f3 = 0.003
        self.mu = nn.Linear(self.fc2_dims, n_actions) # hard coded for now
